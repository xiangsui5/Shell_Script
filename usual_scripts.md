### 目录
* [批量创建多个用户并设置密码](#批量创建多个用户并设置密码)
* [一键查看服务器利用率](#一键查看服务器利用率)
* [找出占用CPU 内存过高的进程](#找出占用cpu-内存过高的进程)
* [查看网卡的实时流量](#查看网卡的实时流量)
* [监控多台服务器磁盘利用率脚本](#监控多台服务器磁盘利用率脚本)
* [批量检测网站是否异常并邮件通知](#批量检测网站是否异常并邮件通知)
* [批量主机远程执行命令脚本](#批量主机远程执行命令脚本)
* [一键部署LNMP网站平台脚本](#一键部署lnmp网站平台脚本)
* [监控MySQL主从同步状态是否异常脚本](#监控mysql主从同步状态是否异常脚本)
* [MySql数据库备份脚本](#mysql数据库备份脚本)
  * [分库备份](#分库备份)
  * [分表备份](#分表备份)
* [Nginx访问日志分析](#nginx访问日志分析)
* [Nginx访问日志自动按天（周、月）切割](#nginx访问日志自动按天周月切割)
* [自动发布Java项目（Tomcat）](#自动发布java项目tomcat)
* [自动发布PHP项目](#自动发布php项目)
* [目录入侵检测与告警](#目录入侵检测与告警)
